...
const PREFIXES: Record<string, Category> = {
  ...
  'auto-cols': 'layout',
  'auto-rows': 'layout',
  // Margin is room around a thing, which is where it sits — the decision of
  // whatever is placing it, not of the thing itself.
  m: 'layout',
  mx: 'layout',
  my: 'layout',
  mt: 'layout',
  ...
  ms: 'layout',
  me: 'layout',
  // Spacing: the room a thing takes up inside itself, which is its size.
  p: 'spacing',
  px: 'spacing',
  py: 'spacing',
  pt: 'spacing',
